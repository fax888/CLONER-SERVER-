...
support_chat_id = environ.get('-1001913415805')
reqst_channel = environ.get('-1001913415805')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Vinayjaat698:vinaych12345@grininja.idbqdtu.mongodb.net/?retryWrites=true")
DATABASE_NAME = environ.get('DATABASE_NAME', "grininja")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 'pyroutils.MIN_CHAT_ID = -999999999999
